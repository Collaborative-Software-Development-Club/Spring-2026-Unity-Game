...
//     version 1.18.0
//     from Assets/Sanders, Tristan, Cameron/Scripts/Spells/EssenceInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Sanders, Tristan, Cameron/Scripts/Spells/EssenceInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @EssenceInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""SpellCasting"",
            ""id"": ""e8937d77-518d-4f02-8530-5936678b5098"",
            ""actions"": [
                {
                    ""name"": ""Cast"",
                    ""type"": ""Button"",
                    ""id"": ""2b40400b-dc83-4afe-ad21-70996d01b66c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""6bfdcbed-3924-4ce5-9309-1f75aa2f7712"",
    ...
    ~@EssenceInput()
    {
        UnityEngine.Debug.Assert(!m_SpellCasting.enabled, "This will cause a leak and performance issues, EssenceInput.SpellCasting.Disable() has not been called.");
    }
    ...
    public struct SpellCastingActions
    {
        ...
        /// </summary>
        public SpellCastingActions(@EssenceInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "SpellCasting" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="SpellCastingActions.AddCallbacks(ISpellCastingActions)" />
    /// <seealso cref="SpellCastingActions.RemoveCallbacks(ISpellCastingActions)" />
